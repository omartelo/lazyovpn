...
- See `internal/ui/model/CLAUDE.md` for the package-local architecture guide (UI as the sole model, the imperative-panel convention, the constants/style rules).
